-- Update invoice_quotations table to use auto-increment ID instead of UUID
...
SELECT id, uuid, type, vendor_id, customer_name, customer_mobile
FROM invoice_quotations 
LIMIT 5;

-- Step 1: Create a backup of the current data (optional)
